...
class Application < Sinatra::Base
  ...
  assets {
    ...
    css :application, '/css/application.css', %w(/css/reset.css /css/index.css /css/intro.css /css/cases.css /css/principles.css /css/form.css)
    js :application, '/js/application.js', %w( /js/jquery-1.9.1.js /js/initializer.js /js/cases.js /js/form.js /js/video.js)
